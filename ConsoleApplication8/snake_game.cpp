...
// ============================================================
//  ScoreManager — đọc/ghi điểm cao ra file
// ============================================================
class ScoreManager {
public:
...
private:
    ...
    void initUI() {
        ...
        btnMenuPlay.init(font, "Choi Ngay",
                         sf::Color(50, 180, 80),
                         WIDTH / 2.f - 110.f, 260.f);
        btnMenuExit.init(font, "Thoat",
                         sf::Color(180, 60, 60),
                         WIDTH / 2.f - 110.f, 340.f);
        ...
        btnPlayAgain.init(font, "Choi Lai",
                          sf::Color(50, 180, 80),
                          WIDTH / 2.f - 110.f, 300.f);
        btnBackMenu.init(font, "Menu Chinh",
                         sf::Color(70, 130, 200),
                         WIDTH / 2.f - 110.f, 375.f);
        btnExitGO.init(font,   "Thoat",
                       sf::Color(180, 60, 60),
                       WIDTH / 2.f - 110.f, 450.f);
    }

    // Cập nhật vị trí text điểm số (gọi mỗi khi cần render GAMEOVER)
...
private:
    ...
    void render() {
        ...
        if (state == MENU) {
            ...
            drawGrid();
            // Đa hình: gọi draw() qua con trỏ base class
